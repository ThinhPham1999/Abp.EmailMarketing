...
namespace Abp.EmailMarketing.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update EmailMarketingDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update EmailMarketingEfCoreEntityExtensionMappings to extend the IdentityUser entity
