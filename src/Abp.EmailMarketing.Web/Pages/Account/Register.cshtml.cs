...
namespace Abp.EmailMarketing.Web.Pages.Account
{
    public class CustomRegisterModelModel : RegisterModel
    {
        private readonly IAccountAppService _accountAppService;
        private readonly IEmailSender _emailSender;
        private Volo.Abp.Identity.IdentityUser _abpIdentityUser;

        public CustomRegisterModelModel(IAccountAppService accountAppService, IEmailSender emailSender) : base(accountAppService)
        {
        ...
        private async Task SendEmailToAskForEmailConfirmationAsync(Volo.Abp.Identity.IdentityUser user)
        {
            ...
            anotherEmailService.Send("abp@gmail.com", Input.EmailAddress, "Confirm your email",
